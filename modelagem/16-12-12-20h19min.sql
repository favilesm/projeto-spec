...
--
-- Host: localhost
-- Generation Time: Dec 16, 2012 at 08:19 PM
...
(18, 'NOISQVUAMO', '71a579027a5355b3a53feca5c284a7f7');
...
(1, 'oi', '<p>\n	<span style="color: rgb(0, 0, 0); font-family: arial, helvetica, sans-serif; text-align: justify;">Lorem ipsum dolor sit amet, sapien odit adipiscing senectus justo, qui mauris dapibus ultricies, per in viverra gravida et ut suspendisse. Non lacus porttitor ut dolor maecenas, diam eleifend ac arcu pede, nascetur lacus feugiat cras a curabitur vitae, egestas dolor dolor est aliquip integer elementum. Posuere curabitur quisque pariatur quis at, semper quam wisi tortor ipsum. Odio lectus et posuere elit rhoncus, mauris arcu proin, penatibus sed, diam a mattis suspendisse consectetuer tristique, adipiscing vestibulum. Sapien quis curabitur varius sagittis urna. Viverra enim cras amet, suscipit nibh quis, vel sodales quis, duis suspendisse vel. Massa et nunc id gravida est, amet vestibulum etiam quisque sit lectus. Nunc at ut eaque nascetur lorem, venenatis mauris, aliquam pellentesque erat integer, ullamcorper enim nam. Nibh magna id bibendum ut pede sed, ac wisi id donec dui cras dignissim, amet omnis porta placerat sociis, nec in, eleifend tristique magna fusce. Ante cras scelerisque gravida, risus donec nunc. Magna aliquet leo sed rutrum montes wisi.</span></p>\n'),
(3, 'dfgdfg', '<p>\n	sdfgsg</p>\n'),
(4, 'NOISQVUAMO', '<p>\n	NOISQVUAMO</p>\n');
...
(1, 'teste', '<p>    testelkfjhklfgjgjghk</p>', 21, 0),
...
(41, 'teste', '<p>AEAEAE AEAEAE SDFHGKSDFGH SDFKGHAE AE AEAEAE AEAEAE SDFHGKSDFGH SDFKGHAE AEAEAEAE AEAEAE SDFHGKSDFGH SDFKGHAE AEAEAEAE AEAEAE SDFHGKSDFGH SDFKGHAE AEAEAEAE AEAEAE SDFHGKSDFGH SDFKGHAE AEAEAEAE AEAEAE SDFHGKSDFGH SDFKGHAE AEAEAEAE AEAEAE SDFHGKSDFGH SDFKGHAE AEAEAEAE AEAEAE SDFHGKSDFGH SDFKGHAE AE</p>'),
(44, 'sfghdf', '<p>\n	dfhdfh</p>\n'),
(45, 'shdf', '<p>\n	dfjdfj</p>\n'),
(46, 'NOISQVUAMO', '<p>\n	NOISQVUAMO</p>\n');
...
(26, '5', NULL, NULL, NULL, NULL, NULL, NULL, 'teste', '76d80224611fc919a5d54f0ff9fba446', 'Não ativada', 0, ''),
