...
<div id="container">
	<h1>Prefeitura</h1>
        <div>
            <?php
               foreach( $prefeituras as $a){
                    echo '<li>'.anchor("main/deletar_prefeitura/$a->prefeitura_id",'Deletar').$a->nome_prefeitura.'</li>';
               };
	...
	<div id="body">
		<p>Dados da prefeitura.</p>
                <?php 
                    ...
                    echo ('Nome');
                    echo form_input('nome_prefeitura');     
                    echo ('Município');
                    ...
                    echo form_input('num_habitantes');
                    echo ('<br> Fax');
                    echo form_input('fax');
                    echo ('UF');
                    echo form_input('uf');
                    echo ('E-mail');
                    echo form_input('email_prefeitura');
                    echo ('Senha');
                    echo form_password('senha');
                    echo ('Ativada');
                    echo form_input('ativada');
                    echo form_fieldset_close();
                    echo form_fieldset('Dados do prefeito');
                    echo ('Nome do prefeito');
                    echo form_input('nome_prefeito'); 
                    echo ('Celular');
                    ...
                    echo form_input('data_nacimento');
                    echo ('E-mail');
                    echo form_input('email_prefeito'); 
                    echo form_fieldset_close();
                    echo form_fieldset('Secretários');
                    echo ('Nome do secretário');
                    echo form_input('nome_secretario'); 
                    echo ('E-mail');
                    echo form_input('email_secretario'); 
                    echo ('Funcao');
                    echo form_input('funcao'); 
                    echo form_fieldset_close();
