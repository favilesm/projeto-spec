...
--
-- Servidor: localhost
-- Tempo de Geração: 04/12/2012 às 16h18min
...
CREATE TABLE IF NOT EXISTS `mensagem` (
  ...
  `titulo_mensagem` varchar(45) DEFAULT NULL,
  `texto_mensagem` varchar(45) DEFAULT NULL,
  `prefeitura_prefeitura_id` int(11) NOT NULL,
  `administrador_administrador_id` int(11) NOT NULL,
  PRIMARY KEY (`mensagem_id`,`prefeitura_prefeitura_id`),
...
(1, 'oi', 'oioioi', 'j', 'jh', 'jh', 222, 'hj', 'hj', 'hj', 'hj', 'h', 2, 2),
(13, '9087', '809', '78097', '890', '789', 89, '7809', '78', NULL, NULL, '789', 789, NULL),
...
CREATE TABLE IF NOT EXISTS `programa` (
  ...
  `texto_programa` varchar(45) DEFAULT NULL,
...
--
-- Restrições para a tabela `prefeitura_x_noticia`
--
ALTER TABLE `prefeitura_x_noticia`
  ADD CONSTRAINT `fk_prefeitura_has_noticia_noticia1` FOREIGN KEY (`noticia_noticia_id`) REFERENCES `noticia` (`noticia_id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  ADD CONSTRAINT `fk_prefeitura_has_noticia_prefeitura1` FOREIGN KEY (`prefeitura_prefeitura_id`) REFERENCES `prefeitura` (`prefeitura_id`) ON DELETE NO ACTION ON UPDATE NO ACTION;

--
-- Restrições para a tabela `secretario`
--
ALTER TABLE `secretario`
  ADD CONSTRAINT `fk_secretario_prefeitura1` FOREIGN KEY (`prefeitura_prefeitura_id`) REFERENCES `prefeitura` (`prefeitura_id`) ON DELETE NO ACTION ON UPDATE NO ACTION;
